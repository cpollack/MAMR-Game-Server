...
//////////////////////////////////////////////////////////////////////
BOOL CMsgNameW::Create(char* pbufMsg, DWORD dwMsgSize)
{
...
//////////////////////////////////////////////////////////////////////
BOOL CMsgNameW::Create(int nType, const char* pszName, DWORD dwData /*= 0*/)
{
	// param check
...
//////////////////////////////////////////////////////////////////////
BOOL CMsgNameW::CreateHead(int nType, DWORD dwData)
{
	// param check
...
//////////////////////////////////////////////////////////////////////
BOOL CMsgNameW::AppendString(const char* pString, DWORD dwData)
{
	// param check
	if (!pString)
		return false;
...
//////////////////////////////////////////////////////////////////////
void CMsgNameW::Process(void *pInfo)
{
