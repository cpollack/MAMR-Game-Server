...
class CWorldKernel : public IWorld, world_kernel::ISocket, ISynMessage
{
public:
...
protected: // ISocket
	virtual bool SendMsg			(world_kernel::CNetMsgW* pNetMsg);
	virtual bool SendMsg			(SOCKET_ID idSocket, OBJID idMsg, const char* pBuf, int nMsgLen);
	virtual bool SendNpcMsg			(world_kernel::CNetMsgW* pNetMsg);
...
public: // send
	virtual bool SendClientMsg		(SOCKET_ID idSocket, world_kernel::CNetMsgW* pNetMsg);
	virtual bool SendNpcMsg			(OBJID idNpc, world_kernel::CNetMsgW* pNetMsg);
...
public: // account server
	...
	bool SendClientLogin(SOCKET_ID idSocket, OBJID idAccount, DWORD dwCheckData, int usResponseCode, LPCTSTR szMessage);

public: // game server messages
	void SendRole(SOCKET_ID idSocket, OBJID idAccount);
...
public: // MessageBoard ---------------------
	bool SendMapGroupMsgForChatRoom(int nMapGroup,SOCKET_ID idSocket, world_kernel::CNetMsgW* pMsg);
