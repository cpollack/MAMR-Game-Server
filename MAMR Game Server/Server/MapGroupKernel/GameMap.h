...
enum GAMEMAPDATA{
	...
	GAMEMAPDATA_MAPDOC,
	GAMEMAPDATA_TYPE,
	GAMEMAPDATA_MAX_MONSTER,
	GAMEMAPDATA_MONSTER_TYPE0,
	GAMEMAPDATA_MONSTER_TYPE1,
	GAMEMAPDATA_MONSTER_LEVEL0,
	GAMEMAPDATA_MONSTER_LEVEL1,
	GAMEMAPDATA_MONSTER_ORGRATE,
	GAMEMAPDATA_AWARD0, 
	GAMEMAPDATA_AWARD1,
	GAMEMAPDATA_AREA0_X,
	GAMEMAPDATA_AREA0_Y,
	GAMEMAPDATA_AREA0_RANGE,
	GAMEMAPDATA_AREA0_MONSTER0,
	GAMEMAPDATA_AREA0_MONSTERLEV0,
	GAMEMAPDATA_AREA0_MONSTER1,
	GAMEMAPDATA_AREA0_MONSTERLEV1,
	GAMEMAPDATA_AREA0_ORGRATE,
	GAMEMAPDATA_AREA0_AWARD0,
	GAMEMAPDATA_AREA0_AWARD1,
	GAMEMAPDATA_AREA1_X,
	GAMEMAPDATA_AREA1_Y,
	GAMEMAPDATA_AREA1_RANGE,
	GAMEMAPDATA_AREA1_MONSTER0,
	GAMEMAPDATA_AREA1_MONSTERLEV0,
	GAMEMAPDATA_AREA1_MONSTER1,
	GAMEMAPDATA_AREA1_MONSTERLEV1,
	GAMEMAPDATA_AREA1_ORGRATE,
	GAMEMAPDATA_AREA1_AWARD0,
	GAMEMAPDATA_AREA1_AWARD1,
	GAMEMAPDATA_WEATHER=33,
	GAMEMAPDATA_BGMUSIC,
...
public: // block
	CGameBlock&	QueryBlock(int nPosX, int nPosY)		{ 
		return m_setBlock[0][0];
		//return m_setBlock[Block(nPosX)][Block(nPosY)];
	}
	IMapThing*	QueryThingByIndex(int x, int y, int z)	{ return BlockByIndex(x,y).QuerySet()->GetObjByIndex(z); }
	CGameBlock&	BlockByIndex(int x, int y)				{ 
		return m_setBlock[0][0];
		//return m_setBlock[x][y];
	}		// call by FOR_9_xxx
protected:
...
public: // get
	...
	WORD	GetWeather()					{ return m_pData->GetInt(GAMEMAPDATA_WEATHER); }
	WORD	GetBGMusic()					{ return m_pData->GetInt(GAMEMAPDATA_BGMUSIC); }
	WORD	GetBGMusicShow()				{ return m_pData->GetInt(GAMEMAPDATA_BGMUSIC_SHOW); }
	WORD	GetFightMusic()					{ return m_pData->GetInt(GAMEMAPDATA_FIGHTMUSIC); }
