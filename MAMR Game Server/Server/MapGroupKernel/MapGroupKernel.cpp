...
#include "Npc.h"
#include "Agent.h"
#include "Network/MsgSyndicate.h"
#include "DeadLoop.h"
#include "I_mydb.h"
	...
	case	MAPGROUP_CHANGENPC:
		{
			...
			if(_stricmp(pszField, "lookface") == 0)
			{
				//if(strcmp(szOpt, "=") == 0)
				{
			...
			/*else if(_stricmp(pszField, "datastr") == 0)
			{
				//if(strcmp(szOpt, "=") == 0)
				{
			...
			else if(_strnicmp(pszField, "data", 4) == 0)
			{
