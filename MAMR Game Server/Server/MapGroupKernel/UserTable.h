...
enum TASKDATA{
		...
		TASKDATA_TYPE		=1,
		TASKDATA_NPCIC,
		TASKDATA_TRIGGERWORDS,
		TASKDATA_ACCEPTTASKWORDS,
		TASKDATA_REFUCETASKWORDS,
		TASKDATA_ITEMNAME1,
		TASKDATA_ITEMINVENTER1,
		TASKDATA_ITEMNAME2,
		TASKDATA_ITEMINVENTER2,
		TASKDATA_TOPLEVEL,
		TASKDATA_LOWLEVEL,
		TASKDATA_TOPREPUTE,
		TASKDATA_LOWREPUTE,
		TASKDATA_LOWREALREPUTE,
		TASKDATA_LOWPHYSIQUE,
		TASKDATA_LOWFORCE,
		TASKDATA_LOWSTAMINA,
		TASKDATA_LOWSPEED,
		TASKDATA_LOWDEGREE,
		...
		TASKDATA_TEAM,
		TASKDATA_SYNDICATE,
		TASKDATA_SYNDICATEDEGREE,
		TASKDATA_IDNEXT0,
		TASKDATA_IDNEXT1,
		TASKDATA_IDNEXT2,
		TASKDATA_IDNEXT3,
		TASKDATA_MINSTEALEXP,
		TASKDATA_MINSMITHEXP,
		TASKDATA_MINMEDICALEXP,
		TASKDATA_MINCREATIVEEXP,
		TASKDATA_MINSUICIDE,
		TASKDATA_MINMONEY,
		TASKDATA_MINDEED,
		TASKDATA_MAXDEED,
		TASKDATA_MINMETEMPSYCHOSIS,
		TASKDATA_MAXMETEMPSYCHOSIS,
		TASKDATA_MINPK,
		TASKDATA_MAXPK,
		TASKDATA_FREEZE,
		TASKDATA_POSE,
