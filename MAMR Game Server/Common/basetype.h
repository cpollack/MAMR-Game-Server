...
public:
	...
	const String&	FormatLong(long nNum)					{ char buf[]="-2147483648"; m_string = _ltoa(nNum, buf, 10); return *this; }
	const String&	FormatDword(DWORD nNum)					{ char buf[]="-2147483648"; m_string = _ultoa(nNum, buf, 10); return *this; }
...
/*template<> //error matching cont char
