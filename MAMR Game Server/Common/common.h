...
//#define		PURE_VIRTUAL_FUNCTION_ITER	{ ASSERT(!"PURE_VIRTUAL_FUNCTION_ITER"); return std::_Tree_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<const _Kty, _Ty>>>>; }
#endif // LOCAL_DEBUG
